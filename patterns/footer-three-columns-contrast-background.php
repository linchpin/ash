 ...
 * Slug: ash/footer-three-columns-contrast-background
 * Categories: footer
...
<!-- /wp:paragraph -->
<!-- wp:paragraph -->
<p><a href="#"><?php echo esc_html__( 'Privacy Policy', 'ash' ); ?></a> · <a href="#"><?php echo esc_html__( 'Terms of Service', 'ash' ); ?></a> · <a href="#"><?php echo esc_html__( 'Contact Us', 'ash' ); ?></a></p>
<!-- /wp:paragraph -->
