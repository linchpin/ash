 ...
 * Slug: ash/footer-stacked-contrast-background
 * Categories: footer
...
<p class="has-text-align-center has-small-font-size">© <?php echo esc_html( gmdate( 'Y' ) ); ?> Your Company LLC · <a href="#"><?php echo esc_html__( 'Contact Us', 'ash' ); ?></a></p>
<!-- /wp:paragraph --></div>
<!-- /wp:group -->
