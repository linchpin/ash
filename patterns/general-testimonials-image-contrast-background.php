 ...
 * Slug: ash/general-testimonials-image-contrast-background
...
<p style="margin-top:0"><?php echo esc_html__( 'With its clean, minimal design and powerful features, Ash enables agencies to build cool websites.', 'ash' ); ?></p>
<!-- /wp:paragraph -->
